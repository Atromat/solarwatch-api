...
public class SolarWatchController : ControllerBase
{
    ...
    public ActionResult<TimeOnly> GetSunriseTime(string cityName)
    {
        try
        {
            var cityData = _coordDataProvider.GetDataByCity(cityName);
    ...
    public ActionResult<TimeOnly> GetSunsetTime(string cityName)
    {
        try
        {
            var cityData = _coordDataProvider.GetDataByCity(cityName);
